...
BOT_TOKEN = environ.get('BOT_TOKEN', "6890162560:AAFDhX9S4cedZDb0IwAU8LXI4vBoxLxeCoY")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002066503882').split()]
...
REQ_CHANNEL = environ.get("REQ_CHANNEL", '-1002066503882')
REQ_CHANNEL = int(REQ_CHANNEL) if REQ_CHANNEL and id_pattern.search(REQ_CHANNEL) else False
JOIN_REQS_DB = environ.get("JOIN_REQS_DB", DATABASE_URI)

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002120114077'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'YS_Bot_Discussion')
